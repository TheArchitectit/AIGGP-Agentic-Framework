...
- [x] Fingerprinted baselines; severity-escalation and recurrence-after-fix behavior (coh-pol-04, coh-pol-05).
      ...
      already correct and are now pinned against a numeric-budget regression. coh-pol-03's enforcement
      half remains open (design question); coh-pol-07's boundary is reported absent.
